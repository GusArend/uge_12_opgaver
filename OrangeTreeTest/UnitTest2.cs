...
namespace OrangeTreeTest
{
    ...
    public class UnitTest2
    {
        ...
        public void ShouldSetTheTreesAgeToNegativeValue()

        {
            ...
            Assert.AreEqual(0, orangeTree.Age);
...

        {
            ...
            //Assert
            // rettet fra 0 til 4 og fra 10 til 6
            Assert.AreEqual(4, orangeTree.OrangesEaten);

            Assert.AreEqual(6, orangeTree.NumOranges);
